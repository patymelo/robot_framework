...
*** Settings ***
Documentation       Bloqueio de conta 00,10,20,40 e 69 para participante Demais Participantes.
...
TST0001: Usuário bloqueia a conta PROPRIA (00)
    [Tags]       PROGRESSIVO_CADBLC_1768          PROGRESSIVO_FILA_BLOQUEIA_CONTA_EVENTO_PARTICIPANTE_DEMAIS_ON
    [Setup]         Atualizar Status    QBEF-64311    QBEF-64297    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64311    QBEF-64297    ${TEST_STATUS}
...
TST0002: Usuário bloqueia a conta CLIENTE 1 - GERAL (10)
    [Tags]       PROGRESSIVO_CADBLC_1768          PROGRESSIVO_FILA_BLOQUEIA_CONTA_EVENTO_PARTICIPANTE_DEMAIS_ON
    [Setup]         Atualizar Status    QBEF-64312    QBEF-64297    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64312    QBEF-64297    ${TEST_STATUS}
...
TST0003: Usuário bloqueia a conta CLIENTE 2 - GERAL (20)
    [Tags]       PROGRESSIVO_CADBLC_1768          PROGRESSIVO_FILA_BLOQUEIA_CONTA_EVENTO_PARTICIPANTE_DEMAIS_ON
    [Setup]         Atualizar Status    QBEF-64318    QBEF-64297    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64318    QBEF-64297    ${TEST_STATUS}
...
TST0004: Usuário bloqueia a conta INTERMEDIACAO (69)
    [Tags]    PROGRESSIVO_CADBLC_1768          PROGRESSIVO_FILA_BLOQUEIA_CONTA_EVENTO_PARTICIPANTE_DEMAIS_ON
    [Setup]         Atualizar Status    QBEF-64319    QBEF-64297    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64319    QBEF-64297    ${TEST_STATUS}
...
TST0005: Valida miolos de conta do participante Demais Participantes que serão enviados para o B3i
    [Tags]    PROGRESSIVO_CADBLC_1768          PROGRESSIVO_FILA_BLOQUEIA_CONTA_EVENTO_PARTICIPANTE_DEMAIS_ON
    [Setup]     Atualizar Status     QBEF-64320   QBEF-64297   EXECUTING
    [Teardown]  Atualizar Status     QBEF-64320   QBEF-64297   ${TEST_STATUS}
...
${NAME_ZIP_IMG}=          imgTelaNoMeBloqueioContaDemaisParticipante.zip
${NAME_ZIP_CSV}=          csvFilaBancoDeDadosBloqueioContaDemaisParticipante.zip
