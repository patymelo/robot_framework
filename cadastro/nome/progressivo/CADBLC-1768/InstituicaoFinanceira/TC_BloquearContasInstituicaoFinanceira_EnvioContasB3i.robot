...
*** Settings ***
Documentation       Bloqueio de conta 00,10,20,40 e 69 para participante INR.
...
*** Test Cases ***
TST0001: Usuário bloqueia a conta PROPRIA (00) PRINCIPAL
    [Tags]          PROGRESSIVO_CADBLC_1768          PROGRESSIVO_FILA_BLOQUEIA_CONTA_EVENTO_PARTICIPANTE_INSTITUICAO_ON
    [Setup]         Atualizar Status    QBEF-64321    QBEF-64299    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64321    QBEF-64299    ${TEST_STATUS}
    ...
    Quando o usuário entra na ação BLOQUEAR e faz o bloqueio da conta ${CONTA_PRINCIPAL} informando a justificativa (Teste Envia Bloqueio conta 00 principal) e nova conta cobrança/principal ${CONTA_00}
    Então o usuario verifica se o ultimo registro incluido na fila TCTPEVENTO_CADASTRO_B3I entre ${hora_inicio_bloqueio_conta} e ${hora_fim_bloqueio_conta} para a conta ${CONTA_PRINCIPAL} foi com situação BLOQUEADA
TST0002: Usuário bloqueia a conta CLIENTE 1 - GERAL (10)
    [Tags]          PROGRESSIVO_CADBLC_1768          PROGRESSIVO_FILA_BLOQUEIA_CONTA_EVENTO_PARTICIPANTE_INSTITUICAO_ON
    [Setup]         Atualizar Status    QBEF-64322    QBEF-64299    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64322    QBEF-64299    ${TEST_STATUS}
  
    Dado que eu acesse menu de Alteracao de Participante
    Quando o usuário entra na ação BLOQUEAR e faz o bloqueio da conta ${CONTA_10} informando a justificativa (Teste Envia Bloqueio conta 10) e nova conta cobrança/principal ${CONTA_00}
...
TST0003: Usuário bloqueia a conta CLIENTE 2 - GERAL (20)
    [Tags]          PROGRESSIVO_CADBLC_1768          PROGRESSIVO_FILA_BLOQUEIA_CONTA_EVENTO_PARTICIPANTE_INSTITUICAO_ON
    [Setup]         Atualizar Status    QBEF-64323    QBEF-64299    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64323    QBEF-64299    ${TEST_STATUS}
 
    Dado que eu acesse menu de Alteracao de Participante
    Quando o usuário entra na ação BLOQUEAR e faz o bloqueio da conta ${CONTA_20} informando a justificativa (Teste Envia Bloqueio conta 20) e nova conta cobrança/principal ${CONTA_00}
...
TST0004: Usuário bloqueia a conta INTERMEDIACAO (69)
    [Tags]          PROGRESSIVO_CADBLC_1768          PROGRESSIVO_FILA_BLOQUEIA_CONTA_EVENTO_PARTICIPANTE_INSTITUICAO_ON
    [Setup]         Atualizar Status    QBEF-64324    QBEF-64299    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64324    QBEF-64299    ${TEST_STATUS}
  
    Dado que eu acesse menu de Alteracao de Participante
    Quando o usuário entra na ação BLOQUEAR e faz o bloqueio da conta ${CONTA_69} informando a justificativa (Teste Envia Bloqueio conta 69) e nova conta cobrança/principal ${CONTA_00}
...
TST0005: Valida miolos de conta do participante INR que serão enviados para o B3i
    [Tags]          PROGRESSIVO_CADBLC_1768          PROGRESSIVO_FILA_BLOQUEIA_CONTA_EVENTO_PARTICIPANTE_INSTITUICAO_ON
    [Setup]         Atualizar Status     QBEF-64325   QBEF-64299   EXECUTING
    [Teardown]      Atualizar Status     QBEF-64325   QBEF-64299   ${TEST_STATUS}
...
${NAME_ZIP_IMG}=          imgTelaNoMeBloqueioContaInstFinanceira.zip
${NAME_ZIP_CSV}=          csvFilaBancoDeDadosBloqueioContaInstFinanceira.zip
