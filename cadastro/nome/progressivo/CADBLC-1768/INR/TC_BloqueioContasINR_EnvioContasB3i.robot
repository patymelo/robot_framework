...
TST0001: Usuário bloqueia a conta PROPRIA (00)
    [Tags]       PROGRESSIVO_CADBLC_1768          PROGRESSIVO_FILA_BLOQUEIA_CONTA_EVENTO_PARTICIPANTE_INR_ON
    [Setup]         Atualizar Status    QBEF-64301    QBEF-64300    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64301    QBEF-64300    ${TEST_STATUS}
...
TST0002: Usuário bloqueia a conta CLIENTE 1 - GERAL (10)
    [Tags]       PROGRESSIVO_CADBLC_1768          PROGRESSIVO_FILA_BLOQUEIA_CONTA_EVENTO_PARTICIPANTE_INR_ON
    [Setup]         Atualizar Status    QBEF-64302    QBEF-64300    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64302    QBEF-64300    ${TEST_STATUS}
...
TST0003: Usuário bloqueia a conta CLIENTE 2 - GERAL (20)
    [Tags]       PROGRESSIVO_CADBLC_1768          PROGRESSIVO_FILA_BLOQUEIA_CONTA_EVENTO_PARTICIPANTE_INR_ON
    [Setup]         Atualizar Status    QBEF-64303    QBEF-64300    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64303    QBEF-64300    ${TEST_STATUS}
...
TST0004: Usuário bloqueia a conta INTERMEDIACAO (69)
    [Tags]    PROGRESSIVO_CADBLC_1768          PROGRESSIVO_FILA_BLOQUEIA_CONTA_EVENTO_PARTICIPANTE_INR_ON
    [Setup]         Atualizar Status    QBEF-64304    QBEF-64300    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64304    QBEF-64300    ${TEST_STATUS}
...
TST0005: Valida miolos de conta do participante INR que serão enviados para o B3i
    [Tags]    PROGRESSIVO_CADBLC_1768          PROGRESSIVO_FILA_BLOQUEIA_CONTA_EVENTO_PARTICIPANTE_INR_ON
    [Setup]     Atualizar Status     QBEF-64305   QBEF-64300   EXECUTING
    [Teardown]  Atualizar Status     QBEF-64305   QBEF-64300   ${TEST_STATUS}
...
${NAME_ZIP_IMG}=          imgTelaNoMeBloqueioContaINR.zip
${NAME_ZIP_CSV}=          csvFilaBancoDeDadosBloqueioContaINR.zip
