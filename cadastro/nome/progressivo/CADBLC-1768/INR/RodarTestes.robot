*** Settings ***
Documentation       Anexo Log Jira CADBLC1768 - INR
...
${NAME_LOG}=              log.html
${NAME_LOG_EXEC}=         logCADBLC1768INR.html
...
Anexar log de execução no JIRA
    Executar teste      ${CURDIR}    Progressivo: Bloquear Contas Participante INR     ${CURDIR}\\Resultados     PROGRESSIVO_CADBLC_1768
