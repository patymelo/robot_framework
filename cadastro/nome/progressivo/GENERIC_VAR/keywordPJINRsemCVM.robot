...
O usuario preenche - Dados Básicos PJ INR sem CVM
...
O usuario preenche - Dados de Pessoa Jurídica Não Residente
    ...
    O Usuario informa no campo CPF do Representante Legal valor igual a ${CPF}
...
O Usuario clica na seta ${number}
    Click Element   //*[@id="/SIC21/ctp/FormularioPessoaJuridicaNaoResidenteNovoFluxo:br.com.cetip.infra.atributo.tipo.web.FiltroDeDominio:${number}:2:java.lang.String"]
*** Variable ***
