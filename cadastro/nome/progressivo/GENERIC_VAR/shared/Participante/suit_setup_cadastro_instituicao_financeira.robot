...
*** Settings ***
Documentation       Geração de Massa para Instituição Financeira

*** Keywords ***
Gerado massa para participante Instituição Financeira
    ...
    ${CNPJ_PARTICIPANTE}=     Que eu execute a query consultando validando se ja existe cadastro para o participante INSTITUICAO
    IF  "${CNPJ_PARTICIPANTE}" == "${EMPTY}"
        Então que eu realize o cadastro de um novo participante instituição financeira BANCO MULTIPLO 01 utilizando dados do ITAUBM para preencher a familia
    ELSE
