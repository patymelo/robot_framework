...
O usuario preenche - Dados Básicos PF INR com CVM
...
O usuario preenche - Dados de Pessoa Física Não Residente
    ...
    ${DATAFAKE}=                 FakerLibrary.DayOfMonth
    ${MESFAKE}=                  FakerLibrary.Month
    O Usuario informa no campo Data Inicio do Periodo da Situação de Residente Exterior valor igual a ${DATAFAKE}05${ANOFAKE}
...
O Usuario clica na seta ${number}
    Click Element   //*[@id="/SIC21/ctp/FormularioPessoaFisicaNaoResidenteCVMNovoFluxo:br.com.cetip.infra.atributo.tipo.web.FiltroDeDominio:${number}:2:java.lang.String"]
*** Variable ***
