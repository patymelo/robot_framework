...
*** Settings ***
Documentation       Inclusão de conta 00,10,20 e 69 para participante Demais Participantes.
...
*** Test Cases ***
TST0001: Incluindo nova conta miolo (00) para participante demais participantes BANCO MULTIPLO 01 no sistema NoMe
    [Tags]      PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_DEMAIS_PARTICIPANTES_ON
    [Setup]     Atualizar Status     QBEF-64145   QBEF-64144   EXECUTING
    [Teardown]  Atualizar Status     QBEF-64145   QBEF-64144   ${TEST_STATUS}
    ...
    Close Browser
TST0002: Incluindo nova conta miolo (10) para participante demais participantes BANCO MULTIPLO 01 no sistema NoMe
    [Tags]      PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_DEMAIS_PARTICIPANTES_ON
    [Setup]     Atualizar Status     QBEF-64150   QBEF-64144   EXECUTING
    [Teardown]  Atualizar Status     QBEF-64150   QBEF-64144   ${TEST_STATUS}
    ...
    Close Browser
TST0003: Incluindo nova conta miolo (20) para participante demais participantes BANCO MULTIPLO 01 no sistema NoMe
    [Tags]      PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_DEMAIS_PARTICIPANTES_ON
    [Setup]     Atualizar Status     QBEF-64151   QBEF-64144   EXECUTING
    [Teardown]  Atualizar Status     QBEF-64151   QBEF-64144   ${TEST_STATUS}
    ...
    Close Browser
TST0004: Incluindo nova conta miolo (69) para participante demais participantes BANCO MULTIPLO 01 no sistema NoMe
    [Tags]      PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_DEMAIS_PARTICIPANTES_ON
    [Setup]     Atualizar Status     QBEF-64152   QBEF-64144   EXECUTING
    [Teardown]  Atualizar Status     QBEF-64152   QBEF-64144   ${TEST_STATUS}
    ...
    Close Browser   
TST0005: Valida miolos de conta demais participantes BANCO MULTIPLO 01 que serão enviados para o B3i
    [Tags]    PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_DEMAIS_PARTICIPANTES_ON
    [Setup]     Atualizar Status     QBEF-64145   QBEF-64144   EXECUTING
    [Teardown]  Atualizar Status     QBEF-64145   QBEF-64220   ${TEST_STATUS}
