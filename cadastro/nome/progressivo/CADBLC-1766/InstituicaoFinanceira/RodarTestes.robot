*** Settings ***
Documentation       Anexo Log Jira CADBLC1766 - Instituição Financeira
...
Anexar log de execução no JIRA
    Executar teste      ${CURDIR}    Progressivo: Inclusão Contas Participante Instituição Financeira     ${CURDIR}\\Resultados     PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_INSTITUICAO_FINANCEIRA_ON
