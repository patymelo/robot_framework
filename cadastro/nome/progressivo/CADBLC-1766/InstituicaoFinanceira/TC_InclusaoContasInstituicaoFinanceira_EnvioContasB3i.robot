...
*** Settings ***
Documentation       Inclusão de conta 00,10,20 e 69 para participante Instituição Financeira.
...
*** Test Cases ***
TST0001: Incluindo nova conta miolo (00) para participante instituição financeira BANCO MULTIPLO 01 no sistema NoMe
    [Tags]      PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_INSTITUICAO_FINANCEIRA_ON
    [Setup]     Atualizar Status     QBEF-64219   QBEF-64216   EXECUTING
    [Teardown]  Atualizar Status     QBEF-64219   QBEF-64216   ${TEST_STATUS}
    ...
    Close Browser
TST0002: Incluindo nova conta miolo (10) para participante instituição financeira BANCO MULTIPLO 01 no sistema NoMe
    [Tags]      PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_INSTITUICAO_FINANCEIRA_ON
    [Setup]     Atualizar Status     QBEF-64221   QBEF-64216   EXECUTING
    [Teardown]  Atualizar Status     QBEF-64221   QBEF-64216   ${TEST_STATUS}
    ...
    Close Browser
TST0003: Incluindo nova conta miolo (20) para participante instituição financeira BANCO MULTIPLO 01 no sistema NoMe
    [Tags]      PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_INSTITUICAO_FINANCEIRA_ON
    [Setup]     Atualizar Status     QBEF-64222   QBEF-64216   EXECUTING
    [Teardown]  Atualizar Status     QBEF-64222   QBEF-64216   ${TEST_STATUS}
    ...
    Close Browser
TST0004: Incluindo nova conta miolo (69) para participante instituição financeira BANCO MULTIPLO 01 no sistema NoMe
    [Tags]      PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_INSTITUICAO_FINANCEIRA_ON
    [Setup]     Atualizar Status     QBEF-64223   QBEF-64216   EXECUTING
    [Teardown]  Atualizar Status     QBEF-64223   QBEF-64216   ${TEST_STATUS}
    ...
    Close Browser   
TST0005: Valida miolos de conta instituição financeira BANCO MULTIPLO 01 que serão enviados para o B3i
    [Tags]    PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_INSTITUICAO_FINANCEIRA_ON
    [Setup]     Atualizar Status     QBEF-64224   QBEF-64216   EXECUTING
    [Teardown]  Atualizar Status     QBEF-64224   QBEF-64216   ${TEST_STATUS}
