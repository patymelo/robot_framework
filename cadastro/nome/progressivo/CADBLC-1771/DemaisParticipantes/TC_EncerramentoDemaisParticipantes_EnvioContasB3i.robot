...
*** Settings ***
Documentation       Encerramento de participante Demais Participantes.
...
*** Test Cases ***
TST0001: Miolo de contas habilitados na tabela parametro config
    [Tags]    PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_DEMAIS_PARTICIPANTES
...
TST0002: Miolo de contas de participante demais participantes BANCO MULTIPLO 01 que serão enviados para outros sistemas após efetivação
    [Tags]    PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_DEMAIS_PARTICIPANTES

    Dado que eu defina a variavel TAG_NUMBER com o valor TST0002 como uma variavel global
    E que eu realize o cadastro de um novo participante demais participantes BANCO MULTIPLO 01 utilizando dados do ITAUBM para preencher a familia
...
TST0003: Encerramento de participante demais participantes BANCO MULTIPLO 01 no sistema NoMe
    [Tags]    PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_DEMAIS_PARTICIPANTES
...
TST0004: Miolo de contas de participante demais participantes BANCO MULTIPLO 01 que serão enviados para outros sistemas após encerramento
    [Tags]    PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_DEMAIS_PARTICIPANTES
...
TST0005: Miolo de contas de participante demais participantes ACUCAR E ALCOOL que serão enviados para outros sistemas após efetivação
    [Tags]    PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_DEMAIS_PARTICIPANTES

    Dado que eu defina a variavel TAG_NUMBER com o valor TST0005 como uma variavel global
    E que eu realize o cadastro de um novo participante demais participantes ACUCAR E ALCOOL utilizando dados do ITAUBM para preencher a familia
...
TST0006: Encerramento de participante demais participantes com natureza econômica ACUCAR E ALCOOL no sistema NoMe
    [Tags]    PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_DEMAIS_PARTICIPANTES
...
TST0007: Miolo de contas de participante demais participantes ACUCAR E ALCOOL que serão enviados para outros sistemas após encerramento
    [Tags]    PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_DEMAIS_PARTICIPANTES
