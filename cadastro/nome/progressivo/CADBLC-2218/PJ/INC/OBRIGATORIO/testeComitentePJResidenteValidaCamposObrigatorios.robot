...
*** Test Cases ***
TST0001: PJ RESIDENTE (API) - Inclusão ITAUBM Campo Obrigatorio (confirmationDataIndicator) - DONO
...
TST0002: PJ RESIDENTE (API) - Inclusão ITAUBM Campo Obrigatorio (customerAccountHolderCode) - DONO
    ...
    Então a chamada deve ter status 422
TST0003: PJ RESIDENTE (API) - Inclusão ITAUBM Campo Obrigatorio (documentNumber) - DONO
    ...
    Então a chamada deve ter status 422
TST0004: PJ RESIDENTE (API) - Inclusão ITAUBM Campo Obrigatorio (residenceCountryCode) - DONO
    ...
    Então a chamada deve ter status 422
TST0005: PJ RESIDENTE (API) - Inclusão ITAUBM Campo Obrigatorio (taxNatureCode) - DONO
    ...
    Então a chamada deve ter status 422
TST0006: PJ RESIDENTE (API) - Inclusão ITAUBM Campo Obrigatorio (investorName) - DONO
    ...
    Então a chamada deve ter status 422
TST0007: PJ RESIDENTE (API) - Inclusão ITAUBM Campo Obrigatorio (companyStartDate) - DONO
    ...
    Então a chamada deve ter status 422
TST0008: PJ RESIDENTE (API) - Inclusão ITAUBM Campo Obrigatorio (economicActivityCode) - DONO
    ...
    Então a chamada deve ter status 422
TST0009: PJ RESIDENTE (API) - Inclusão ITAUBM Campo Obrigatorio (addressTypeCode) - DONO
    ...
    Então a chamada deve ter status 422
TST0010: PJ RESIDENTE (API) - Inclusão ITAUBM Campo Obrigatorio (addressTypeName) - DONO
    ...
    Então a chamada deve ter status 422
TST0011: PJ RESIDENTE (API) - Inclusão ITAUBM Campo Obrigatorio (addressNumber) - DONO
    ...
    Então a chamada deve ter status 422
TST0012: PJ RESIDENTE (API) - Inclusão ITAUBM Campo Obrigatorio (neighborhoodName) - DONO
    ...
    Então a chamada deve ter status 422
TST0013: PJ RESIDENTE (API) - Inclusão ITAUBM Campo Obrigatorio (stateCode) - DONO
    ...
    Então a chamada deve ter status 422
TST0014: PJ RESIDENTE (API) - Inclusão ITAUBM Campo Obrigatorio (cityCode) - DONO
    ...
    Então a chamada deve ter status 422
TST0015: PJ RESIDENTE (API) - Inclusão ITAUBM Campo Obrigatorio (zipCode) - DONO
    ...
    Então a chamada deve ter status 422
TST0016: PJ RESIDENTE (API) - Inclusão ITAUBM Campo Obrigatorio (countryCode) - DONO
    ...
    Então a chamada deve ter status 422
TST0017: PJ RESIDENTE (API) - Inclusão ITAUBM Campo Obrigatorio (representativeTypeCode) - DONO
    ...
    Então a chamada deve ter status 422
TST0018: PJ RESIDENTE (API) - Inclusão ITAUBM Campo Obrigatorio (documentTypeCode) - DONO
    ...
    Então a chamada deve ter status 422
TST0019: PJ RESIDENTE (API) - Inclusão ITAUBM Campo Obrigatorio (documentNumber) - DONO
    ...
    Que a ${resposta} tenha no erro o valor "O campo \\"documentNumber\\" deve ser informado"
    Então a chamada deve ter status 422
TST0020: PJ RESIDENTE (API) - Inclusão ITAUBM Campo (phoneNumber) Se informado o DDD precisa informar o Telefone - DONO
    ...
    Então a chamada deve ter status 422
TST0021: PJ RESIDENTE (API) - Inclusão ITAUBM Campo (phoneAreaCodeNumber) Se informado o Telefone precisa informar o DDD - DONO
    ...
    Então a chamada deve ter status 422
TST0022: PJ RESIDENTE (API) - Inclusão ITAUBM Campo (phoneTypeCode) Se informado o Telefone ou DD precisa informar o tipo do telefone - DONO
    ...
    Então a chamada deve ter status 422
TST0023: PJ RESIDENTE (API) - Inclusão ITAUBM Campo (giinNumber) Quando um campo do bloco FATCA for preenchido, todos os outros devem ser preenchidos também. - DONO
    ...
    Então a chamada deve ter status 422
TST0024: PJ RESIDENTE (API) - Inclusão ITAUBM Campo (relatedCountryCode) Quando um campo do bloco FATCA for preenchido, todos os outros devem ser preenchidos também. - DONO
    ...
    Então a chamada deve ter status 422
TST0025: PJ RESIDENTE (API) - Inclusão ITAUBM Campo (originCountryCode) Quando um campo do bloco FATCA for preenchido, todos os outros devem ser preenchidos também. - DONO
    ...
    Então a chamada deve ter status 422
TST0026: PJ RESIDENTE (API) - Inclusão ITAUBM Campo (phoneNumber: Representante Procurador) Se informado o DDD precisa informar o Telefone - DONO
    [Documentation]   Teste de API Comitente PJ como Dono do cadastro: Validar campo "Telefone" Se informado o DDD precisa informar o Telefone
    [Tags]    NEGATIVO CAMPO OBRIGATORIO API
    ...
    Que a ${resposta} tenha no erro o valor "O campo \\"phoneNumber\\" deve ser informado."
    Então a chamada deve ter status 422
TST0027: PJ RESIDENTE (API) - Inclusão ITAUBM Campo (phoneAreaCodeNumber: Representante Procurador) Se informado o Telefone precisa informar o DDD - DONO
    [Documentation]   Teste de API Comitente PJ como Dono do cadastro: Validar campo "DDD" Se informado o Telefone precisa informar o DDD
    [Tags]    NEGATIVO CAMPO OBRIGATORIO API
    ...
    Que a ${resposta} tenha no erro o valor "O campo \\"phoneAreaCodeNumber\\" deve ser informado."
    Então a chamada deve ter status 422
TST0028: PJ RESIDENTE (API) - Inclusão ITAUBM Campo (phoneTypeCode: Representante Procurador) Se informado o Telefone ou DD precisa informar o tipo do telefone - DONO
    [Documentation]   Teste de API Comitente PJ como Dono do cadastro: Validar campo "Telefone" Se informado o Telefone ou DD precisa informar o tipo do telefone
    [Tags]    NEGATIVO CAMPO OBRIGATORIO API
