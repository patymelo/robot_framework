...
TST0001: PJ RESIDENTE (API) - Alteração ITAUBM Campo (updateDate) data formato invalido - DONO
...
TST0002: PJ RESIDENTE (API) - Alteração ITAUBM Campo (updateDate) data invalida - DONO
    [Documentation]   Teste de API Comitente PJ como Dono do cadastro: Validar campo "Data de Atualização do Cadastro" não aceita data inválida
    [Tags]    NEGATIVO API
    ...
    Então a chamada deve ter status 422
TST0003: PJ RESIDENTE (API) - Alteração ITAUBM Campo (updateDate) data futura - DONO
    ...
    Então a chamada deve ter status 422
TST0004: PJ RESIDENTE (API) - Alteração ITAUBM Campo (customerAccountHolderCode) Conta Invalida - DONO
    ...
    Então a chamada deve ter status 422
TST0005: PJ RESIDENTE (API) - Alteração ITAUBM Campo (customerAccountHolderCode) Valida conta diferente header e body - DONO
    [Documentation]   Teste de API Comitente PJ como Dono do cadastro: Valida conta diferente header e body
    [Tags]    NEGATIVO API
    ...
    ${resposta}=    Que eu faça uma chamada PUT enviando o ${body} com erro de negocio
    Set Global Variable  ${resposta}
    Que a ${resposta} tenha no erro o valor "Alteração não permitida: Conta principal do comitente diferente da conta informada para alteração"
    Então a chamada deve ter status 422
TST0006: PJ RESIDENTE (API) - Alteração ITAUBM Campo (individualDepositAccountCode) Não pode repetir conta de deposito - DONO
    ...
    Então a chamada deve ter status 422
TST0007: PJ RESIDENTE (API) - Alteração ITAUBM Campo (documentNumber) Não aceitar CPF - DONO
    ...
    ${CNPJ_COMITENTE_OLD}=   Set Variable   ${CNPJ_COMITENTE}
    ...
    ${CNPJ_COMITENTE}=   Set Variable   ${CNPJ_COMITENTE_OLD}
    Set Global Variable  ${CNPJ_COMITENTE}
TST0008: PJ RESIDENTE (API) - Alteração ITAUBM Campo (documentNumber) Não aceitar CNPJ invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0009: PJ RESIDENTE (API) - Alteração ITAUBM Campo (residenceCountryCode) Não aceita País diferente de Brasil - DONO
    ...
    Então a chamada deve ter status 422
TST0010: PJ RESIDENTE (API) - Alteração ITAUBM Campo (selicAccountCode) Conta Invalida - DONO
    ...
    Então a chamada deve ter status 422
TST0012: PJ RESIDENTE (API) - Alteração ITAUBM Campo (annualIncomeValue) Nao deve ser preenchido se campo moeda vazio - DONO*
    ...
    Então a chamada deve ter status 422
TST0013: PJ RESIDENTE (API) - Alteração ITAUBM Campo (annualIncomeDate) Nao deve ser preenchido se campo Valor da Renda Anual vazio - DONO
    ...
    Então a chamada deve ter status 422
TST0014: PJ RESIDENTE (API) - Alteração ITAUBM Campo (annualIncomeDate) Validar dado invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0015: PJ RESIDENTE (API) - Alteração ITAUBM Campo (annualIncomeDate) Validar data formato invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0016: PJ RESIDENTE (API) - Alteração ITAUBM Campo (annualIncomeDate) Validar data futura - DONO
    ...
    Então a chamada deve ter status 422
TST0017: PJ RESIDENTE (API) - Alteração ITAUBM Campo (equityValue) Nao deve ser preenchido se campo moeda vazio - DONO
    ...
    Que a ${resposta} tenha no erro o valor "(Situação Patrimonial) Valor Patrimônio Líquido não pode ser preenchido se Moeda estiver vazio"
    Então a chamada deve ter status 422
TST0018: PJ RESIDENTE (API) - Alteração ITAUBM Campo (equityDate) Validar dado invalido - DONO
    [Documentation]   Teste de API Comitente PJ como Dono do cadastro: Validar campo "Data da Renda Anual" Validar dado invalido com letra
    [Tags]    NEGATIVO API
    ...
    Então a chamada deve ter status 422
TST0019: PJ RESIDENTE (API) - Alteração ITAUBM Campo (equityDate) Validar data formato invalido - DONO
    [Documentation]   Teste de API Comitente PJ como Dono do cadastro: Validar campo "Data da Renda Anual" Validar data formato invalido
    [Tags]    NEGATIVO API
    ...
    Então a chamada deve ter status 422
TST0020: PJ RESIDENTE (API) - Alteração ITAUBM Campo (equityDate) Validar data futura - DONO
    [Documentation]   Teste de API Comitente PJ como Dono do cadastro: Validar campo "Data da Renda Anual" Validar data futura
    [Tags]    NEGATIVO API
    ...
    Então a chamada deve ter status 422
TST0021: PJ RESIDENTE (API) - Alteração ITAUBM Campo (billingDate) Validar dado invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0022: PJ RESIDENTE (API) - Alteração ITAUBM Campo (billingDate) Validar data formato invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0023: PJ RESIDENTE (API) - Alteração ITAUBM Campo (billingDate) Validar data futura - DONO
    ...
    Então a chamada deve ter status 422
TST0024: PJ RESIDENTE (API) - Alteração ITAUBM Campo (companyStartDate) Validar dado invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0025: PJ RESIDENTE (API) - Alteração ITAUBM Campo (companyStartDate) Validar data formato invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0026: PJ RESIDENTE (API) - Alteração ITAUBM Campo (companyStartDate) Validar data futura - DONO
    ...
    Então a chamada deve ter status 422
TST0027: PJ RESIDENTE (API) - Alteração ITAUBM Campo (riskClassificationName) Dado Obrigatorio se riskClassificationName igual O - DONO
    ...
    Então a chamada deve ter status 422
TST0028: PJ RESIDENTE (API) - Alteração ITAUBM Campo (economicActivityCode) Dado Invalido 999 - DONO
    ...
    Então a chamada deve ter status 422
TST0029: PJ RESIDENTE (API) - Alteração ITAUBM Campo (economicActivityCode) Dado Invalido 55 - DONO
    ...
    Que a ${resposta} tenha no erro o valor "CNAE - Atividade Principal Desenvolvida inválida"
    Então a chamada deve ter status 422
TST0030: PJ RESIDENTE (API) - Alteração ITAUBM Campo (stateCode) Dado Invalido "ZZ"(99)- DONO
    ...
    Então a chamada deve ter status 422
TST0031: PJ RESIDENTE (API) - Alteração ITAUBM Campo (stateCode) Dado Invalido "UF"(00)- DONO
    ...
    #Que a ${resposta} tenha no erro o valor "UF inválido para o campo UF."
    Então a chamada deve ter status 422
TST0032: PJ RESIDENTE (API) - Alteração ITAUBM Campo (cityCode) Dado Invalido 0 - DONO
    ...
    Então a chamada deve ter status 422
TST0033: PJ RESIDENTE (API) - Alteração ITAUBM Campo (cityCode) Dado Invalido 999 - DONO
    ...
    Então a chamada deve ter status 422
TST0034: PJ RESIDENTE (API) - Alteração ITAUBM Campo (zipCode) Dado Invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0035: PJ RESIDENTE (API) - Alteração ITAUBM Campo (representativeTypeCode) Se valor preenchido for igual a "Procurador", o campo "authorizeOrderTransmissionByThird" precisa ser = "P" - DONO
    ...
    Então a chamada deve ter status 422
TST0036: PJ RESIDENTE (API) - Alteração ITAUBM Campo (representativeTypeCode) Tipo de representante Responsável pela Custódia não permite o preenchimento de nenhum campo referente a endereço. - DONO
    ...
    Então a chamada deve ter status 422
TST0037: PJ RESIDENTE (API) - Alteração ITAUBM Campo (documentTypeCode: Representante) Valor "OUTROS" pode ser indicado para representantes do tipo "Controlada" e "Coligada" - DONO
    ...
    Então a chamada deve ter status 422
TST0038: PJ RESIDENTE (API) - Alteração ITAUBM Campo (documentTypeCode: Representante) Valor "CNPJ" pode ser indicado para representantes do tipo "Controlador Direto PJ", "Controladora", "Controlada" e "Coligada" - DONO
    ...
    Que a ${resposta} tenha no erro o valor "Para Representante Procurador Não residente , o Tipo de documento deve ser CPF."
    Então a chamada deve ter status 422
TST0039: PJ RESIDENTE (API) - Alteração ITAUBM Campo (politicallyExposedPersonCode: Representante) Não é permitido o preenchimento caso o representante seja igual a "Administrador", "Coligada", "Controlada", "Controladora", "Controlador Direto PJ", "Responsavel pela Custodia" - DONO
    ...
    Então a chamada deve ter status 422
TST0040: PJ RESIDENTE (API) - Alteração ITAUBM Campo (stateCode: Representante Procurador) Dado Invalido "ZZ"(99)- DONO
    [Documentation]   Teste de API Comitente PJ como Dono do cadastro: Validar campo "UF" Dado invalido 99.
    [Tags]    NEGATIVO API
    ...
    Então a chamada deve ter status 422
TST0041: PJ RESIDENTE (API) - Alteração ITAUBM Campo (stateCode: Representante Procurador) Dado Invalido "UF"(00)- DONO
    [Documentation]   Teste de API Comitente PJ como Dono do cadastro: Validar campo "UF" Dado invalido 0.
    [Tags]    NEGATIVO API
    ...
    #Que a ${resposta} tenha no erro o valor "UF inválido para o campo UF (Representante)"
    Então a chamada deve ter status 422
TST0042: PJ RESIDENTE (API) - Alteração ITAUBM Campo (cityCode: Representante Procurador) Dado Invalido 0 - DONO
    [Documentation]   Teste de API Comitente PJ como Dono do cadastro: Validar campo "Tipo Município" Dado invalido 0.
    [Tags]    NEGATIVO API
    ...
    Que a ${resposta} tenha no erro o valor "Município 0 inválido para o UF 26."
    Então a chamada deve ter status 422
TST0043: PJ RESIDENTE (API) - Alteração ITAUBM Campo (cityCode: Representante Procurador) Dado Invalido 999 - DONO
    [Documentation]   Teste de API Comitente PJ como Dono do cadastro: Validar campo "Tipo Município" Dado invalido 999.
    [Tags]    NEGATIVO API
    ...
    Que a ${resposta} tenha no erro o valor "Município 999 inválido para o UF 26."
    Então a chamada deve ter status 422
TST0044: PJ RESIDENTE (API) - Alteração ITAUBM Campo (zipCode: Representante Procurador) Dado Invalido - DONO
    [Documentation]   Teste de API Comitente PJ como Dono do cadastro: Validar campo "CEP" Dado invalido.
    [Tags]    NEGATIVO API
