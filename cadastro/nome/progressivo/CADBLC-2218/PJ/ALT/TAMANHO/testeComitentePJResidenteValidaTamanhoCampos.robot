...
TST0001: PJ RESIDENTE (API) - Alteração ITAUBM Campo (leiCode) Tamanho maximo 20 caracteres - DONO
...
TST0002: PJ RESIDENTE (API) - Alteração ITAUBM Campo (giinNumber) Tamanho maximo 19 caracteres - DONO
    ...
    Então a chamada deve ter status 422
TST0003: PJ RESIDENTE (API) - Alteração ITAUBM Campo (economicGroupName) Tamanho maximo 20 caracteres - DONO
    ...
    Então a chamada deve ter status 422
TST0004: PJ RESIDENTE (API) - Alteração ITAUBM Campo (riskClassificationName) Tamanho maximo 20 caracteres - DONO
    ...
    Então a chamada deve ter status 422
TST0005: PJ RESIDENTE (API) - Alteração ITAUBM Campo (addressTypeName) Tamanho maximo 40 caracteres - DONO
    ...
    Então a chamada deve ter status 422
TST0006: PJ RESIDENTE (API) - Alteração ITAUBM Campo (addressNumber) Tamanho maximo 20 caracteres - DONO
    ...
    Então a chamada deve ter status 422
TST0007: PJ RESIDENTE (API) - Alteração ITAUBM Campo (investorName) Tamanho maximo 100 caracteres - DONO
    ...
    Então a chamada deve ter status 422
TST0008: PJ RESIDENTE (API) - Alteração ITAUBM Campo (addressComplementName) Tamanho maximo 40 caracteres - DONO
    ...
    Então a chamada deve ter status 422
TST0009: PJ RESIDENTE (API) - Alteração ITAUBM Campo (neighborhoodName) Tamanho maximo 40 caracteres - DONO
    ...
    Então a chamada deve ter status 422
TST0010: PJ RESIDENTE (API) - Alteração ITAUBM Campo (emailName) Tamanho maximo 100 caracteres - DONO
    ...
    Então a chamada deve ter status 422
TST0011: PJ RESIDENTE (API) - Alteração ITAUBM Campo (phoneAreaCodeNumber) Tamanho maximo 3 caracteres - DONO
    ...
    Então a chamada deve ter status 422
TST0012: PJ RESIDENTE (API) - Alteração ITAUBM Campo (phoneNumber) Tamanho maximo 10 caracteres - DONO
    ...
    Então a chamada deve ter status 422
TST0013: PJ RESIDENTE (API) - Alteração ITAUBM Campo (phoneExtension) Tamanho maximo 5 caracteres - DONO
    ...
    Então a chamada deve ter status 422
TST0014: PJ RESIDENTE (API) - Alteração ITAUBM Campo (addressTypeName) Tamanho maximo 40 caracteres - DONO
    ...
    Que a ${resposta} tenha no erro o valor "Erro [CONTEUDO_COM_TAMANHO_MAIOR_QUE_PERMITIDO : Tamanho do conteúdo maior do que o permitido.] no campo \\u0027addressTypeName\\u0027"
    Então a chamada deve ter status 422
TST0015: PJ RESIDENTE (API) - Alteração ITAUBM Campo (addressNumber) Tamanho maximo 20 caracteres - DONO
    ...
    Que a ${resposta} tenha no erro o valor "Erro [CONTEUDO_COM_TAMANHO_MAIOR_QUE_PERMITIDO : Tamanho do conteúdo maior do que o permitido.] no campo \\u0027addressNumber\\u0027"
    Então a chamada deve ter status 422
TST0016: PJ RESIDENTE (API) - Alteração ITAUBM Campo (addressComplementName) Tamanho maximo 40 caracteres - DONO
    ...
    Que a ${resposta} tenha no erro o valor "Erro [CONTEUDO_COM_TAMANHO_MAIOR_QUE_PERMITIDO : Tamanho do conteúdo maior do que o permitido.] no campo \\u0027addressComplementName\\u0027"
    Então a chamada deve ter status 422
TST0017: PJ RESIDENTE (API) - Alteração ITAUBM Campo (neighborhoodName) Tamanho maximo 40 caracteres - DONO
    ...
    Que a ${resposta} tenha no erro o valor "Erro [CONTEUDO_COM_TAMANHO_MAIOR_QUE_PERMITIDO : Tamanho do conteúdo maior do que o permitido.] no campo \\u0027neighborhoodName\\u0027"
    Então a chamada deve ter status 422
TST0018: PJ RESIDENTE (API) - Alteração ITAUBM Campo (emailName) Tamanho maximo 100 caracteres - DONO
    ...
    Que a ${resposta} tenha no erro o valor "Erro [CONTEUDO_COM_TAMANHO_MAIOR_QUE_PERMITIDO : Tamanho do conteúdo maior do que o permitido.] no campo \\u0027emailName\\u0027"
    Então a chamada deve ter status 422
TST0019: PJ RESIDENTE (API) - Alteração ITAUBM Campo (phoneAreaCodeNumber) Tamanho maximo 3 caracteres - DONO
    ...
    Que a ${resposta} tenha no erro o valor "Erro [CONTEUDO_COM_TAMANHO_MAIOR_QUE_PERMITIDO : Tamanho do conteúdo maior do que o permitido.] no campo \\u0027phoneAreaCodeNumber\\u0027"
    Então a chamada deve ter status 422
TST0020: PJ RESIDENTE (API) - Alteração ITAUBM Campo (phoneExtension) Tamanho maximo 5 caracteres - DONO
    ...
    Que a ${resposta} tenha no erro o valor "Erro [CONTEUDO_COM_TAMANHO_MAIOR_QUE_PERMITIDO : Tamanho do conteúdo maior do que o permitido.] no campo \\u0027phoneExtension\\u0027"
    Então a chamada deve ter status 422
TST0021: PJ RESIDENTE (API) - Alteração ITAUBM Campo (phoneNumber) Tamanho maximo 10 caracteres - DONO
    ...
    Que a ${resposta} tenha no erro o valor "Erro [CONTEUDO_COM_TAMANHO_MAIOR_QUE_PERMITIDO : Tamanho do conteúdo maior do que o permitido.] no campo \\u0027phoneNumber\\u0027"
    Então a chamada deve ter status 422
TST0022: PJ RESIDENTE (API) - Alteração ITAUBM Campo (representativeName) Tamanho maximo 100 caracteres - DONO
