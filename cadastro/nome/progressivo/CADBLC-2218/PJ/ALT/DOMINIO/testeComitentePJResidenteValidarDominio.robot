...
TST0001: PJ RESIDENTE (API) - Alteração ITAUBM Campo (confirmationDataIndicator) diferente de true e false - DONO
...
TST0002: PJ RESIDENTE (API) - Alteração ITAUBM Campo (taxNatureCode) Dominio invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0003: PJ RESIDENTE (API) - Alteração ITAUBM Campo (documentNumber) Não aceitar Padrao diferente de CNPJ e CPF- DONO
    ...
    Então a chamada deve ter status 422
TST0004: PJ RESIDENTE (API) - Alteração ITAUBM Campo (taxNatureCode) Dominio Invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0005: PJ RESIDENTE (API) - Alteração ITAUBM Campo (currencyCode) Dominio invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0006: PJ RESIDENTE (API) - Alteração ITAUBM Campo (annualIncomeValue) Dominio invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0007: PJ RESIDENTE (API) - Alteração ITAUBM Campo (equityValue) Dominio invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0008: PJ RESIDENTE (API) - Alteração ITAUBM Campo (lastYearBillingValue) Dominio invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0009: PJ RESIDENTE (API) - Alteração ITAUBM Campo (relatedCountryCode) Dominio invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0010: PJ RESIDENTE (API) - Alteração ITAUBM Campo (relatedCountryCode) Dominio invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0011: PJ RESIDENTE (API) - Alteração ITAUBM Campo (authorizeOrderTransmissionByThird) Dominio invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0012: PJ RESIDENTE (API) - Alteração ITAUBM Campo (nonProfitCompanyIndicator) Dado invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0013: PJ RESIDENTE (API) - Alteração ITAUBM Campo (administrativePortfolioManagerIndicator) Dado invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0014: PJ RESIDENTE (API) - Alteração ITAUBM Campo (investmentFundAdministratorIndicator) Dado invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0015: PJ RESIDENTE (API) - Alteração ITAUBM Campo (riskClassificationCode) Dado invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0016: PJ RESIDENTE (API) - Alteração ITAUBM Campo (addressTypeCode) Dado Invalido - DONO
   ...
   #Que a ${resposta} tenha no erro o valor "Erro [DOMINIO_INVALIDO : RESIDENCIAL inválido] no campo \\u0027addressTypeCode\\u0027"
    Então a chamada deve ter status 422
TST0017: PJ RESIDENTE (API) - Alteração ITAUBM Campo (stateCode) Dado Invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0018: PJ RESIDENTE (API) - Alteração ITAUBM Campo (countryCode) Dado Invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0019: PJ RESIDENTE (API) - Alteração ITAUBM Campo (emailTypeCode) Dominio invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0020: PJ RESIDENTE (API) - Alteração ITAUBM Campo (phoneTypeCode) Dominio invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0021: PJ RESIDENTE (API) - Alteração ITAUBM Campo (representativeTypeCode) Dominio Invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0022: PJ RESIDENTE (API) - Alteração ITAUBM Campo (documentTypeCode: Representante) Dominio invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0023: PJ RESIDENTE (API) - Alteração ITAUBM Campo (politicallyExposedPersonCode: Representante) Dominio Invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0024: PJ RESIDENTE (API) - Alteração ITAUBM Campo (addressTypeCode: Representante Procurador) Dado Invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0025: PJ RESIDENTE (API) - Alteração ITAUBM Campo (stateCode: Representante Procurador) Dado Invalido - DONO
    [Documentation]   Teste de API Comitente PJ como Dono do cadastro: Validar campo "UF" Dado invalido.
    [Tags]    NEGATIVO DOMINIO INVALIDO API
    ...
    Que a ${resposta} tenha no erro o valor "Erro [DOMINIO_INVALIDO : Domínio inválido] no campo \\u0027stateCode\\u0027"
    Então a chamada deve ter status 422
TST0026: PJ RESIDENTE (API) - Alteração ITAUBM Campo (countryCode: Representante Procurador) Dado Invalido - DONO
    [Documentation]   Teste de API Comitente PJ como Dono do cadastro: Validar campo "País" Dado invalido.
    [Tags]    NEGATIVO DOMINIO INVALIDO API
    ...
    Que a ${resposta} tenha no erro o valor "Erro [DOMINIO_INVALIDO : Domínio inválido] no campo \\u0027countryCode\\u0027"
    Então a chamada deve ter status 422
TST0027: PJ RESIDENTE (API) - Alteração ITAUBM Campo (emailTypeCode: Representante Procurador) Dominio invalido - DONO
    [Documentation]   Teste de API Comitente PJ como Dono do cadastro: Validar campo "Tipo de E-mail" Dominio invalido. Valores aceitos: "COMERCIAL", "PARTICULAR"
    [Tags]    NEGATIVO DOMINIO INVALIDO API
    ...
    #Que a ${resposta} tenha no erro o valor "Erro [DOMINIO_INVALIDO : PRIVADO inválido] no campo \\u0027emailTypeCode\\u0027"
    Então a chamada deve ter status 422
TST0028: PJ RESIDENTE (API) - Alteração ITAUBM Campo (phoneTypeCode: Representante Procurador) Dominio invalido - DONO
    [Documentation]   Teste de API Comitente PJ como Dono do cadastro: Validar campo "Tipo de Telefone" Dominio invalido. Valores aceitos: "COMERCIAL", "PARTICULAR"
    [Tags]    NEGATIVO DOMINIO INVALIDO API
    ...
    Então a chamada deve ter status 422
    Sleep  2s
TST0029: PJ RESIDENTE (API) - Alteração ITAUBM Campo (emailName) Dominio invalido - DONO
    ...
    Então a chamada deve ter status 422
TST0030: PJ RESIDENTE (API) - Alteração ITAUBM Campo (emailName: Representante Procurador) Dominio invalido - DONO
    [Documentation]   Teste de API Comitente PJ como Dono do cadastro: Validar campo "E-mail" Dominio invalido
    [Tags]    NEGATIVO DOMINIO INVALIDO API
