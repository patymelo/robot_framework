...
*** Settings ***
Documentation       Alteração de conta 00,10,20,40 e 69 para participante Emissor.
...
TST0001: Usuário altera dados de conta PROPRIA (00) e não altera a situação
    [Tags]    PROGRESSIVO_CADBLC_1767          PROGRESSIVO_FILA_ALTERA_CONTA_EVENTO_PARTICIPANTE_EMISSOR_ON
    [Setup]         Atualizar Status    QBEF-64251    QBEF-64239    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64251    QBEF-64239    ${TEST_STATUS}
...
TST0002: Usuário altera dados de conta CLIENTE 1 - GERAL (10) e não altera a situação
    [Tags]    PROGRESSIVO_CADBLC_1767          PROGRESSIVO_FILA_ALTERA_CONTA_EVENTO_PARTICIPANTE_EMISSOR_ON
    [Setup]         Atualizar Status    QBEF-64252    QBEF-64239    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64252    QBEF-64239    ${TEST_STATUS}
...
TST0003: Usuário altera dados de conta CLIENTE 2 - GERAL (20) e não altera a situação
    [Tags]    PROGRESSIVO_CADBLC_1767          PROGRESSIVO_FILA_ALTERA_CONTA_EVENTO_PARTICIPANTE_EMISSOR_ON
    [Setup]         Atualizar Status    QBEF-64253    QBEF-64239    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64253    QBEF-64239    ${TEST_STATUS}
...
TST0004: Usuário altera dados de conta INTERMEDIACAO (69) e não altera a situação
    [Tags]    PROGRESSIVO_CADBLC_1767          PROGRESSIVO_FILA_ALTERA_CONTA_EVENTO_PARTICIPANTE_EMISSOR_ON
    [Setup]         Atualizar Status    QBEF-64254    QBEF-64239    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64254    QBEF-64239    ${TEST_STATUS}
...
TST0005: Usuário altera situacão de conta PROPRIA (00)
    [Tags]    PROGRESSIVO_CADBLC_1767         PROGRESSIVO_FILA_ALTERA_CONTA_EVENTO_PARTICIPANTE_EMISSOR_ON
    [Setup]         Atualizar Status    QBEF-64255    QBEF-64239    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64255    QBEF-64239    ${TEST_STATUS}
    Dado que eu acesse menu de Alteracao de Participante verifica a situação atual da conta ${CONTA_00}
...
TST0006: Usuário altera situacão de conta CLIENTE 1 - GERAL (10)
    [Tags]    PROGRESSIVO_CADBLC_1767         PROGRESSIVO_FILA_ALTERA_CONTA_EVENTO_PARTICIPANTE_EMISSOR_ON
    [Setup]         Atualizar Status    QBEF-64256    QBEF-64239    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64256    QBEF-64239    ${TEST_STATUS}
    Dado que eu acesse menu de Alteracao de Participante verifica a situação atual da conta ${CONTA_10}
...
TST0007: Usuário altera situacão de conta CLIENTE 2 - GERAL (20)
    [Tags]    PROGRESSIVO_CADBLC_1767          PROGRESSIVO_FILA_ALTERA_CONTA_EVENTO_PARTICIPANTE_EMISSOR_ON
    [Setup]         Atualizar Status    QBEF-64257    QBEF-64239    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64257    QBEF-64239    ${TEST_STATUS}
    Dado que eu acesse menu de Alteracao de Participante verifica a situação atual da conta ${CONTA_20}
...
TST0008: Usuário altera situacão de conta INTERMEDIACAO (69)
    [Tags]    PROGRESSIVO_CADBLC_1767          PROGRESSIVO_FILA_ALTERA_CONTA_EVENTO_PARTICIPANTE_EMISSOR_ON
    [Setup]         Atualizar Status    QBEF-64258    QBEF-64239    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64258    QBEF-64239    ${TEST_STATUS}
    Dado que eu acesse menu de Alteracao de Participante verifica a situação atual da conta ${CONTA_69}
    Então o usuário altera a situação da conta ${CONTA_69} de acordo com a situação atual
TST0009: Usuário altera situacão de conta EMISSORA (40)
    [Tags]    PROGRESSIVO_CADBLC_1767          PROGRESSIVO_FILA_ALTERA_CONTA_EVENTO_PARTICIPANTE_EMISSOR_ON
    [Setup]         Atualizar Status    QBEF-64260    QBEF-64239    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64260    QBEF-64239    ${TEST_STATUS}
    Dado que eu acesse menu de Alteracao de Participante verifica a situação atual da conta ${CONTA_69}
    Então o usuário altera a situação da conta ${CONTA_40} de acordo com a situação atual    
TST0010: Valida miolos de conta emissor BANCO MULTIPLO 01 que serão enviados para o B3i
    [Tags]    PROGRESSIVO_CADBLC_1767          PROGRESSIVO_FILA_ALTERA_CONTA_EVENTO_PARTICIPANTE_EMISSOR_ON
    [Setup]     Atualizar Status     QBEF-64259   QBEF-64239   EXECUTING
    [Teardown]  Atualizar Status     QBEF-64259   QBEF-64239   ${TEST_STATUS}

    ${list_contas}      Set Variable       '${CONTA_00}','${CONTA_10}','${CONTA_20}','${CONTA_40}','${CONTA_69}'
    ${miolo_contas_habilitado}     Create List     .00-  .10-  .20-  .40-
