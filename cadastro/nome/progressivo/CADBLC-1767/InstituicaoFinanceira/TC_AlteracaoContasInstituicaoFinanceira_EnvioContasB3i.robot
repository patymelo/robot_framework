...
*** Settings ***
Documentation       Alteração de conta 00,10,20,40 e 69 para participante Instituição Financeira.
...
TST0001: Usuário altera dados de conta PROPRIA (00) e não altera a situação
    [Tags]    PROGRESSIVO_CADBLC_1767       PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_INSTITUICAO_FINANCEIRA_ON
    [Setup]         Atualizar Status    QBEF-64245    QBEF-64237    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64245    QBEF-64237    ${TEST_STATUS}
...
TST0002: Usuário altera dados de conta CLIENTE 1 - GERAL (10) e não altera a situação
    [Tags]    PROGRESSIVO_CADBLC_1767       PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_INSTITUICAO_FINANCEIRA_ON
    [Setup]         Atualizar Status    QBEF-64246    QBEF-64237    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64246    QBEF-64237    ${TEST_STATUS}
...
TST0003: Usuário altera dados de conta CLIENTE 2 - GERAL (20) e não altera a situação
    [Tags]    PROGRESSIVO_CADBLC_1767       PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_INSTITUICAO_FINANCEIRA_ON
    [Setup]         Atualizar Status    QBEF-64247    QBEF-64237    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64247    QBEF-64237    ${TEST_STATUS}
...
TST0004: Usuário altera dados de conta INTERMEDIACAO (69) e não altera a situação
    [Tags]    PROGRESSIVO_CADBLC_1767       PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_INSTITUICAO_FINANCEIRA_ON
    [Setup]         Atualizar Status    QBEF-64248    QBEF-64237    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64248    QBEF-64237    ${TEST_STATUS}
...
TST0005: Usuário altera situacão de conta PROPRIA (00)
    [Tags]    PROGRESSIVO_CADBLC_1767       PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_INSTITUICAO_FINANCEIRA_ON
    [Setup]         Atualizar Status    QBEF-64241    QBEF-64237    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64241    QBEF-64237    ${TEST_STATUS}
    Dado que eu acesse menu de Alteracao de Participante verifica a situação atual da conta ${CONTA_00}
...
TST0006: Usuário altera situacão de conta CLIENTE 1 - GERAL (10)
    [Tags]    PROGRESSIVO_CADBLC_1767       PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_INSTITUICAO_FINANCEIRA_ON
    [Setup]         Atualizar Status    QBEF-64242    QBEF-64237    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64242    QBEF-64237    ${TEST_STATUS}
    Dado que eu acesse menu de Alteracao de Participante verifica a situação atual da conta ${CONTA_10}
...
TST0007: Usuário altera situacão de conta CLIENTE 2 - GERAL (20)
    [Tags]    PROGRESSIVO_CADBLC_1767       PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_INSTITUICAO_FINANCEIRA_ON
    [Setup]         Atualizar Status    QBEF-64243    QBEF-64237    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64243    QBEF-64237    ${TEST_STATUS}
    Dado que eu acesse menu de Alteracao de Participante verifica a situação atual da conta ${CONTA_20}
...
TST0008: Usuário altera situacão de conta INTERMEDIACAO (69)
    [Tags]    PROGRESSIVO_CADBLC_1767       PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_INSTITUICAO_FINANCEIRA_ON
    [Setup]         Atualizar Status    QBEF-64244    QBEF-64237    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64244    QBEF-64237    ${TEST_STATUS}
    Dado que eu acesse menu de Alteracao de Participante verifica a situação atual da conta ${CONTA_69}
    Então o usuário altera a situação da conta ${CONTA_69} de acordo com a situação atual
TST0009: Valida miolos de conta instituição financeira BANCO MULTIPLO 01 que serão enviados para o B3i
    [Tags]    PROGRESSIVO_CADBLC_1767       PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_INSTITUICAO_FINANCEIRA_ON
    [Setup]     Atualizar Status     QBEF-64249   QBEF-64237   EXECUTING
    [Teardown]  Atualizar Status     QBEF-64249   QBEF-64237   ${TEST_STATUS}
