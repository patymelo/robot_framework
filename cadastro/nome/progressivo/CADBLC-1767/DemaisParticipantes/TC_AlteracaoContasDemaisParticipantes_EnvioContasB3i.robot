...
*** Settings ***
Documentation       Alteração de conta 00,10,20 e 69 para participante Demais Participantes.
...
...                 Gerado massa para participante Demais Participantes  AND
...
TST0001: Usuário altera dados de conta PROPRIA (00) e não altera a situação
    [Tags]    PROGRESSIVO_CADBLC_1767       PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_DEMAIS_PARTICIPANTES_ON
    [Setup]         Atualizar Status    QBEF-64262    QBEF-64240    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64262    QBEF-64240    ${TEST_STATUS}
...
TST0002: Usuário altera dados de conta CLIENTE 1 - GERAL (10) e não altera a situação
    [Tags]    PROGRESSIVO_CADBLC_1767       PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_DEMAIS_PARTICIPANTES_ON
    [Setup]         Atualizar Status    QBEF-64263    QBEF-64240    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64263    QBEF-64240    ${TEST_STATUS}
...
TST0003: Usuário altera dados de conta CLIENTE 2 - GERAL (20) e não altera a situação
    [Tags]    PROGRESSIVO_CADBLC_1767       PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_DEMAIS_PARTICIPANTES_ON
    [Setup]         Atualizar Status    QBEF-64264    QBEF-64240    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64264    QBEF-64240    ${TEST_STATUS}
...
TST0004: Usuário altera dados de conta INTERMEDIACAO (69) e não altera a situação
    [Tags]    PROGRESSIVO_CADBLC_1767       PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_DEMAIS_PARTICIPANTES_ON
    [Setup]         Atualizar Status    QBEF-64265    QBEF-64240    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64265    QBEF-64240    ${TEST_STATUS}
...
TST0005: Usuário altera situacão de conta PROPRIA (00)
    [Tags]    PROGRESSIVO_CADBLC_1767       PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_DEMAIS_PARTICIPANTES_ON
    [Setup]         Atualizar Status    QBEF-64266    QBEF-64240    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64266    QBEF-64240    ${TEST_STATUS}
    Dado que eu acesse menu de Alteracao de Participante verifica a situação atual da conta ${CONTA_00}
...
TST0006: Usuário altera situacão de conta CLIENTE 1 - GERAL (10)
    [Tags]    PROGRESSIVO_CADBLC_1767       PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_DEMAIS_PARTICIPANTES_ON
    [Setup]         Atualizar Status    QBEF-64267    QBEF-64240    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64267    QBEF-64240    ${TEST_STATUS}
    Dado que eu acesse menu de Alteracao de Participante verifica a situação atual da conta ${CONTA_10}
...
TST0007: Usuário altera situacão de conta CLIENTE 2 - GERAL (20)
    [Tags]    PROGRESSIVO_CADBLC_1767       PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_DEMAIS_PARTICIPANTES_ON
    [Setup]         Atualizar Status    QBEF-64268    QBEF-64240    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64268    QBEF-64240    ${TEST_STATUS}
    Dado que eu acesse menu de Alteracao de Participante verifica a situação atual da conta ${CONTA_20}
...
TST0008: Usuário altera situacão de conta INTERMEDIACAO (69)
    [Tags]    PROGRESSIVO_CADBLC_1767       PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_DEMAIS_PARTICIPANTES_ON
    [Setup]         Atualizar Status    QBEF-64272    QBEF-64240    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64272    QBEF-64240    ${TEST_STATUS}
    Dado que eu acesse menu de Alteracao de Participante verifica a situação atual da conta ${CONTA_69}
    Então o usuário altera a situação da conta ${CONTA_69} de acordo com a situação atual
TST0009: Valida miolos de conta demais participantes BANCO MULTIPLO 01 que serão enviados para o B3i
    [Tags]    PROGRESSIVO_CADBLC_1767       PROGRESSIVO_FILA_EVENTO_PARTICIPANTE_DEMAIS_PARTICIPANTES_ON
    [Setup]     Atualizar Status     QBEF-64269   QBEF-64240   EXECUTING
    [Teardown]  Atualizar Status     QBEF-64269   QBEF-64240   ${TEST_STATUS}
