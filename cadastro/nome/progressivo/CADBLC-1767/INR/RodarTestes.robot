*** Settings ***
Documentation       Anexo Log Jira CADBLC1767 - INR
...
Anexar log de execução no JIRA
    Executar teste      ${CURDIR}    Progressivo: Alteração Contas Participante INR     ${CURDIR}\\Resultados     PROGRESSIVO_CADBLC_1767
