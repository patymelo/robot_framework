...
*** Settings ***
Documentation       Encerrar conta 00,10,20,40 e 69 para participante Demais Participantes.
...
...                 Gerado massa para participante DemaisParticipantes  AND
...
TST0001: Usuário encerra a conta PROPRIA (00)
    [Tags]          PROGRESSIVO_CADBLC_1769          PROGRESSIVO_FILA_ENCERRAR_CONTA_EVENTO_PARTICIPANTE_DEMAIS_ON
    [Setup]         Atualizar Status    QBEF-64512    QBEF-64374    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64512    QBEF-64374    ${TEST_STATUS}
...
TST0002: Usuário encerra a conta CLIENTE 1 - GERAL (10)
    [Tags]          PROGRESSIVO_CADBLC_1769          PROGRESSIVO_FILA_ENCERRAR_CONTA_EVENTO_PARTICIPANTE_DEMAIS_ON
    [Setup]         Atualizar Status    QBEF-64513    QBEF-64374    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64513    QBEF-64374    ${TEST_STATUS}
...
TST0003: Usuário encerra a conta CLIENTE 2 - GERAL (20)
    [Tags]          PROGRESSIVO_CADBLC_1769          PROGRESSIVO_FILA_ENCERRAR_CONTA_EVENTO_PARTICIPANTE_DEMAIS_ON
    [Setup]         Atualizar Status    QBEF-64514    QBEF-64374    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64514    QBEF-64374    ${TEST_STATUS}
...
TST0004: Usuário encerra a conta INTERMEDIACAO (69)
    [Tags]          PROGRESSIVO_CADBLC_1769          PROGRESSIVO_FILA_ENCERRAR_CONTA_EVENTO_PARTICIPANTE_DEMAIS_ON
    [Setup]         Atualizar Status    QBEF-64515    QBEF-64374    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64515    QBEF-64374    ${TEST_STATUS}
...
TST0005: Valida miolos de conta do participante Demais Participantes que serão enviados para o B3i
    [Tags]          PROGRESSIVO_CADBLC_1769          PROGRESSIVO_FILA_ENCERRAR_CONTA_EVENTO_PARTICIPANTE_DEMAIS_ON
    [Setup]         Atualizar Status     QBEF-64516   QBEF-64374   EXECUTING
    [Teardown]      Atualizar Status     QBEF-64516   QBEF-64374   ${TEST_STATUS}
...
${NAME_ZIP_IMG}=          imgTelaNoMeEncerramentoContaDemaisParticipantes.zip
${NAME_ZIP_CSV}=          csvFilaBancoDeDadosEncerramentoContaDemaisParticipantes.zip
