...
*** Settings ***
Documentation       Encerrar conta 00,10,20,40 e 69 para participante INR.
...
TST0001: Usuário encerra a conta PROPRIA (00)
    [Tags]          PROGRESSIVO_CADBLC_1769          PROGRESSIVO_FILA_ENCERRAR_CONTA_EVENTO_PARTICIPANTE_INR_ON
    [Setup]         Atualizar Status    QBEF-64500    QBEF-64376    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64500    QBEF-64376    ${TEST_STATUS}
...
TST0002: Usuário encerra a conta CLIENTE 1 - GERAL (10)
    [Tags]          PROGRESSIVO_CADBLC_1769          PROGRESSIVO_FILA_ENCERRAR_CONTA_EVENTO_PARTICIPANTE_INR_ON
    [Setup]         Atualizar Status    QBEF-64502    QBEF-64376    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64502    QBEF-64376    ${TEST_STATUS}
...
TST0003: Usuário encerra a conta CLIENTE 2 - GERAL (20)
    [Tags]          PROGRESSIVO_CADBLC_1769          PROGRESSIVO_FILA_ENCERRAR_CONTA_EVENTO_PARTICIPANTE_INR_ON
    [Setup]         Atualizar Status    QBEF-64503    QBEF-64376    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64503    QBEF-64376    ${TEST_STATUS}
...
TST0004: Usuário encerra a conta INTERMEDIACAO (69)
    [Tags]          PROGRESSIVO_CADBLC_1769          PROGRESSIVO_FILA_ENCERRAR_CONTA_EVENTO_PARTICIPANTE_INR_ON
    [Setup]         Atualizar Status    QBEF-64504    QBEF-64376    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64504    QBEF-64376    ${TEST_STATUS}
...
TST0005: Valida miolos de conta do participante INR que serão enviados para o B3i
    [Tags]          PROGRESSIVO_CADBLC_1769          PROGRESSIVO_FILA_ENCERRAR_CONTA_EVENTO_PARTICIPANTE_INR_ON
    [Setup]         Atualizar Status     QBEF-64505   QBEF-64376   EXECUTING
    [Teardown]      Atualizar Status     QBEF-64505   QBEF-64376   ${TEST_STATUS}
...
${NAME_ZIP_IMG}=          imgTelaNoMeEncerramentoContaINR.zip
${NAME_ZIP_CSV}=          csvFilaBancoDeDadosEncerramentoContaINR.zip
