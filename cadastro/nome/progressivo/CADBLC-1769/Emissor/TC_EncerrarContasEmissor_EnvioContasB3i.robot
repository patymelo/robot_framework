...
*** Settings ***
Documentation       Encerrar conta 00,10,20,40 e 69 para participante Emissor.
...
TST0001: Usuário encerra a conta PROPRIA (00)
    [Tags]          PROGRESSIVO_CADBLC_1769          PROGRESSIVO_FILA_ENCERRAR_CONTA_EVENTO_PARTICIPANTE_EMISSOR_ON
    [Setup]         Atualizar Status    QBEF-64507    QBEF-64375    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64507    QBEF-64375    ${TEST_STATUS}
...
TST0002: Usuário encerra a conta CLIENTE 1 - GERAL (10)
    [Tags]          PROGRESSIVO_CADBLC_1769          PROGRESSIVO_FILA_ENCERRAR_CONTA_EVENTO_PARTICIPANTE_EMISSOR_ON
    [Setup]         Atualizar Status    QBEF-64508    QBEF-64375    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64508    QBEF-64375    ${TEST_STATUS}
...
TST0003: Usuário encerra a conta CLIENTE 2 - GERAL (20)
    [Tags]          PROGRESSIVO_CADBLC_1769          PROGRESSIVO_FILA_ENCERRAR_CONTA_EVENTO_PARTICIPANTE_EMISSOR_ON
    [Setup]         Atualizar Status    QBEF-64509    QBEF-64375    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64509    QBEF-64375    ${TEST_STATUS}
...
TST0004: Usuário encerra a conta INTERMEDIACAO (69)
    [Tags]          PROGRESSIVO_CADBLC_1769          PROGRESSIVO_FILA_ENCERRAR_CONTA_EVENTO_PARTICIPANTE_EMISSOR_ON
    [Setup]         Atualizar Status    QBEF-64510    QBEF-64375    EXECUTING
    [Teardown]      Atualizar Status    QBEF-64510    QBEF-64375    ${TEST_STATUS}
...
TST0005: Valida miolos de conta do participante Emissor que serão enviados para o B3i
    [Tags]          PROGRESSIVO_CADBLC_1769          PROGRESSIVO_FILA_ENCERRAR_CONTA_EVENTO_PARTICIPANTE_EMISSOR_ON
    [Setup]         Atualizar Status     QBEF-64511   QBEF-64375   EXECUTING
    [Teardown]      Atualizar Status     QBEF-64511   QBEF-64375   ${TEST_STATUS}
...
${NAME_ZIP_IMG}=          imgTelaNoMeEncerramentoContaEmissor.zip
${NAME_ZIP_CSV}=          csvFilaBancoDeDadosEncerramentoContaEmissor.zip
